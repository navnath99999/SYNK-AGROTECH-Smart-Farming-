...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:20%;" id="mySidebar">
  <a href="Welcome.html" onclick="w3_close()" class="w3-bar-item w3-button">Home</a>
...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px; margin:auto">
    ...
    <div class="w3-button w3-padding-16 w3-right" onclick="w3_open()"> <a href="Registration.html"> <img src="/Cart.jpg" alt="Cart" style="width:60px;"> </a> </div>
...
<a href="Admin_Info.html"><h4> Show Customer List </h4></a>
<a href="Admin_Info1.html"><h4> Show Supplier List </h4></a>
